...
위키백과는 종이 기반 참고 자료와는 아주 다르게 실시간으로 함께 편집합니다. 위키백과는 끊임없이 새로 만들어지고 갱신되므로 역사적 사건에 관한 항목은 수분 내에 생성됩니다. 반면에 종이 기반 백과사전에서는 이와 같은 과정이 수개월이나 수년이 걸립니다. 오래 전에 생성된 항목은 시간이 가면서 점점 더 일반화되고 중립적 시각으로 변합니다. 새로 만들어진 항목은 잘못된 정보, 백과사전에 싣기에 부적절한 내용 또는 문서를 훼손하는 내용을 포함할 수 있습니다. 이 점을 주의하면 유용한 정보를 취하고 잘못된 정보를 피하는 데 도움이 됩니다.",
	...
	(1..12).each do |i|
		Listing.create(
			...
			detail: "위키백과는 전 세계 누구나 편집할 수 있는, 다중 언어 웹 기반 자유 콘텐츠 백과사전 프로젝트입니다. “위키백과”라는 이름은 함께 참여하여 웹사이트를 만드는 기술인 ‘위키’(하와이어로 “빠른”을 뜻함)와 ‘백과사전’을 합한 혼성어입니다. 위키백과 항목은 관련 정보가 링크로 서로 연결되어 있습니다. 

위키백과는 전 세계 누구나 편집할 수 있는, 다중 언어 웹 기반 자유 콘텐츠 백과사전 프로젝트입니다. “위키백과”라는 이름은 함께 참여하여 웹사이트를 만드는 기술인 ‘위키’(하와이어로 “빠른”을 뜻함)와 ‘백과사전’을 합한 혼성어입니다. 위키백과 항목은 관련 정보가 링크로 서로 연결되어 있습니다.",
			).tap do |listing|
				if i > 5
